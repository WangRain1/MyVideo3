...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader{
	...
	private void initView(Context context) {
         ...
         * 动画对象
         */
        headerAnim = (ImageView) findViewById(R.id.scalerIMG);
	...
	public void setState(int state) {
		...
		switch(state){
            case STATE_NORMAL:  //下拉的时候
                ...
                break;
            case STATE_RELEASE_TO_REFRESH:  //下拉到高度超过 40 时
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    mStatusTextView.setText(R.string.listview_header_hint_release);
                }
                break;
            case STATE_REFRESHING:  //松手了 开始刷新的时候
                headerAnim.setImageResource(R.drawable.tween);
                //动画效果
                animationDrawable = (AnimationDrawable)headerAnim.getDrawable();

                animationDrawable.start();

                mStatusTextView.setText(R.string.refreshing);
                break;
            case STATE_DONE:     //刷新完成时候
                headerAnim.setImageResource(R.drawable.head_image_0);
...
//        if (headerAnim!=null){
//            headerAnim.setScaleY(1.0f+rate);
//            headerAnim.setScaleX(1.0f+rate);
//        }
