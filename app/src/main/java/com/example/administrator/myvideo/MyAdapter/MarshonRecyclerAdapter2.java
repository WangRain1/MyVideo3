 ...
 * DESC:
 */
public abstract class MarshonRecyclerAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Lives> mDatas;
    private  Context mContext;

    private MyItemClickListener mItemClickListener;

    public MarshonRecyclerAdapter2(Context context, List<Lives> mDatas){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView=View.inflate(mContext, R.layout.listitem2,null);
